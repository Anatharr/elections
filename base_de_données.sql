...
-- par cantons dans la table t1_2011 depuis le fichier .csv qui 
...
-- Résultats élections départementales 2011 tour 2 par cantons
...
-- par cantons dans la table t2_2011 depuis le fichier .csv qui 
-- contient les données
...
-- par cantons dans la table t1_2015 depuis le fichier .csv qui 
-- contient les données
...
-- par cantons dans la table t2_2015 depuis le fichier .csv qui 
-- contient les données
...
(
    ...
    voix_pourcent_ins_liste_14 numeric(10,3),
    voix_pourcent_exp_liste_14 numeric(10,3),
